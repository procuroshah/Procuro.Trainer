...
namespace LearningManagementSystem.Shared.Authorization;
...
public static class FshPermissions
{
    ...
    [     
        ...
        //courses
        new("View Courses", FshActions.View, FshResources.Courses, IsBasic: true),
        new("Search Courses", FshActions.Search, FshResources.Courses),
        new("AddUpdate Courses", FshActions.Create, FshResources.Courses),
        new("Delete Courses", FshActions.Delete, FshResources.Courses),
